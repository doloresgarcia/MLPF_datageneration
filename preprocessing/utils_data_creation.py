...
def get_genparticles_and_adjacencies( prop_data, hit_data, calohit_links, sitrack_links, iev, collectionIDs, eval_dataset=False):
    ...
    if eval_dataset:
        ...
        pfo_to_calohit[pfo_to_calohit_nolink_mask[0]] = -1 #if no link set to -1
