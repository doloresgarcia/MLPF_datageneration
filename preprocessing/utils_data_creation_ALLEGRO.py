...
mc_coll = "MCParticles"
track_coll = "TracksFromGenParticles"
...
def get_calohit_matrix_and_genadj(hit_data, calohit_links, iev, collectionIDs):
    ...
    calohit_to_gen_weight = calohit_links["CaloHitMCParticleLinks.weight"][iev]
    
    calohit_to_gen_calo_colid = calohit_links["_CaloHitMCParticleLinks_from/_CaloHitMCParticleLinks_from.collectionID"][iev]
    calohit_to_gen_gen_colid = calohit_links["_CaloHitMCParticleLinks_to/_CaloHitMCParticleLinks_to.collectionID"][iev]
    calohit_to_gen_calo_idx = calohit_links["_CaloHitMCParticleLinks_from/_CaloHitMCParticleLinks_from.index"][iev]
    calohit_to_gen_gen_idx = calohit_links["_CaloHitMCParticleLinks_to/_CaloHitMCParticleLinks_to.index"][iev]
...
def track_to_features(prop_data, iev):
    ...
    for k in ["tanLambda", "D0", "phi", "omega", "Z0", "time", "referencePoint.x", "referencePoint.y", "referencePoint.z"]:
        ret[k] = awkward.to_numpy(prop_data["_TracksFromGenParticles_trackStates"]["_TracksFromGenParticles_trackStates." + k][iev][trackstate_idx])
    
    ret["referencePoint_calo.x"] = awkward.to_numpy(prop_data["_TracksFromGenParticles_trackStates"]["_TracksFromGenParticles_trackStates.referencePoint.x"][iev][trackstate_idx+3])
    ret["referencePoint_calo.y"] = awkward.to_numpy(prop_data["_TracksFromGenParticles_trackStates"]["_TracksFromGenParticles_trackStates.referencePoint.y"][iev][trackstate_idx+3])
    ret["referencePoint_calo.z"] = awkward.to_numpy(prop_data["_TracksFromGenParticles_trackStates"]["_TracksFromGenParticles_trackStates.referencePoint.z"][iev][trackstate_idx+3])
    ret["phi_calo"] = awkward.to_numpy(prop_data["_TracksFromGenParticles_trackStates"]["_TracksFromGenParticles_trackStates.phi"][iev][trackstate_idx+3])
    ret["tanLambda_calo"] = awkward.to_numpy(prop_data["_TracksFromGenParticles_trackStates"]["_TracksFromGenParticles_trackStates.tanLambda"][iev][trackstate_idx+3])
    ret["omega_calo"] = awkward.to_numpy(prop_data["_TracksFromGenParticles_trackStates"]["_TracksFromGenParticles_trackStates.omega"][iev][trackstate_idx+3])
...
def genparticle_track_adj(sitrack_links, iev):
    trk_to_gen_trkidx = sitrack_links["_TracksFromGenParticlesAssociation_from/_TracksFromGenParticlesAssociation_from.index"][iev]
    trk_to_gen_genidx = sitrack_links["_TracksFromGenParticlesAssociation_to/_TracksFromGenParticlesAssociation_to.index"][iev]
    trk_to_gen_w = sitrack_links["TracksFromGenParticlesAssociation.weight"][iev]
