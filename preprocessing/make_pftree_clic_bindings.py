...
for i, event in enumerate(reader.get("events")):
    ...
    toc = time.time()
    print("gen_particles_find",     toc-tic_start)
    tic = time.time()
    ...
    toc = time.time()
    print("store_gen_particles",     toc-tic)
    tic = time.time()
    n_hit[0] = 0
    ...
    toc = time.time()
    print("store_calo_hits",toc-tic)
    print("total event time",toc-tic_start)
